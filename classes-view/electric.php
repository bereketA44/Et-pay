...
<style>
    ...
    .mainField{
        background-image: url(../media/Dashboard/Epole.png);
        background-color: whitesmoke;
        padding: 0 50px;
        padding: 30px 0;
    }
...
<div class="mainContent">
    ...
    <form action="javascript:void(0);" class="form-horizontal" id="paymentForm">
            ...
            <div class="form-group">
                <label for="BillNUmber" class="control-label col-sm-3 col-xs-12">Enter Bill Number: </label>
                <div class="col-sm-6 col-xs-12">
                    <input type="Number" name="BillNUmber" placeholder="Bill Number"class="form-control " required>
                </div>
            </div>
            <div class="namebox">
            ...
            <div class="form-group otpDiv">
                ...
                <button data-payment-type="Electric Bill" class="btn btn-success payBtn col-sm-offset-6 col-xs-offset-5 col-sm-1 ">Pay!</button>
            </div>
        </form>
    </div>
</div>
