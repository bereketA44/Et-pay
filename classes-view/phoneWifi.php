...
<style>
    ...
    .mainField{
        background-image: url(../media/Dashboard/PhoneConn.png);
...
<div class="mainContent">
    <div class="header">
        <h2>Phone and Wifi Bill</h2>
    </div>
    <div class="mainField">
    <form action="javascript:void(0);" class="form-horizontal" id="paymentForm">
            <div class="col-sm-offset-4 col-xs-offset-0 checkbox" >
                <div>
                        <label for="Wifi">Pay for Wifi: </label><input type="checkbox" name="Wifi" id="wificheck" checked> 
                </div>

                <div>
                        <label for="phone">Pay for Phone: </label><input type="checkbox" name="phone" id="phonecheck">
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="BillNUmber" class="control-label col-sm-3 col-xs-12" id="billLabel">Enter Wifi Bill Number: </label>
                <div class="col-sm-6 col-xs-12">
                    <input id="billInput" type="Number" name="BillNUmber" placeholder="Bill Number"class="form-control " required>
                </div>
            </div>
            <div class="namebox">
            ...
            <div class="form-group otpDiv">
                ...
                <button data-payment-type="Phone And Wifi Bill" class="btn btn-success payBtn col-sm-offset-6 col-xs-offset-5 col-sm-1 ">Pay!</button>
            </div>
        </form>
    </div>
</div>
    ...
    $(function () {
        $('#wificheck').click(function(){
            if (this.checked) {
                ...
                $('#billLabel').html('Enter Wifi Bill Number');
                $("#billInput").attr("placeholder", "Bill Number");
            }
        }) 
        $('#phonecheck').click(function(){
            if (this.checked) {
                $("#wificheck").prop('checked', false);
                $('#billLabel').html('Enter Phone Number');
                $("#billInput").attr("placeholder", "Phone Number");
            }
        }) 
    });
</script>