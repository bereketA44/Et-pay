...
<style>
    ...
    .mainField{
        background-image: url(../media/Dashboard/tap.png);
...
<div class="mainContent">
    ...
    <form action="javascript:void(0);" class="form-horizontal" id="paymentForm">
            ...
            <div class="form-group otpDiv">
                ...
                <button data-payment-type="Water Bill" class="btn btn-success payBtn col-sm-offset-6 col-xs-offset-5 col-sm-1 ">Pay!</button>
            </div>
        </form>
    </div>
</div>
